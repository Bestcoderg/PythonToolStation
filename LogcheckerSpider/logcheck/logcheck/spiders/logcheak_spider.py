...
class logcheck(scrapy.Spider):
    ...
    def start_requests(self):
        headers = {
            ...
            'Cookie': 'SESSa64839a716c20ebf9d6397bc8d05d905=GPzEMXUHmEZE63G4faRBHnD9dIRyh5Sq6Ag4gjX2gOI; dhtml_menu=dhtml_menu-2044,dhtml_menu-2048,dhtml_menu-2062'
        }
        urls = []
        year = "2020"
        ...
        url2 = "&role_id=795448397382403711"
